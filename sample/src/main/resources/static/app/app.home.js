...
let HomeComponent = class HomeComponent {
    constructor() {
        ...
        this.charts = [
            ...
            new model_1.ImageModel("PieChart", "img/chart/pie-chart.png", "piechart", "Pie and doughnut charts are probably the most commonly used chart there are. They are divided into segments, the arc of each segment shows the proportional value of each piece of data."),
        ];
        this.contactFields = [
